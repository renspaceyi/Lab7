...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (hit <= 0 || hit > MAX_HIT_POINTS) {
        ...
        System.out.print("Enter your attack lever (1-49): ");
        hit = myScan.nextInt();
        while (hit <= 0 || hit >= MAX_HIT_POINTS) {
            System.out.print("Sorry. The attack level must be between 1 and 49: ");
            hit = myScan.nextInt();
        }
        tempPokemon.attackLevel = hit;

        System.out.print("Enter your defense lever (1-"
                        + (MAX_HIT_POINTS - tempPokemon.attackLevel) + "): ");
        hit = myScan.nextInt();
        while (hit <= 0 || hit > (MAX_HIT_POINTS - tempPokemon.attackLevel)) {
            System.out.print("Sorry. The defense level must be between 1 and "
                            + (MAX_HIT_POINTS - tempPokemon.attackLevel) + ": ");
            hit = myScan.nextInt();
        }
        tempPokemon.defenseLevel = hit;
    ...
    public static void printWhoIsAhead() {
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            ...
            System.out.println("Holy heck, Batman! There's a tie!");
        }
    }
    ...
    public static void determineWinner() {
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            ...
            System.out.println("Holy heck, Batman! This shouldn't be printing!");
        }
    }
